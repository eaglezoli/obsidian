...
1.3 Research Question _(your chosen question)_  
1.4 Rationale for Study _(why this matters generally + locally + personally)_  
1.5 Scope and Boundaries _(what’s included/excluded)_  
1.6 Research Objectives _(3–4 concise points)_
...
2.3 Review of Key Studies _(grouped by theme)_
- Theme 1: Challenges in learning coding for engineering students
- Theme 2: Pedagogical approaches that improve confidence and skills
- Theme 3: Co-creation & student voice in curriculum design _(can include AI as emerging tool)_  
...
3.3 Data Collection Methods _(surveys, focus groups, or both)_  
3.4 Data Analysis Approach _(thematic analysis, coding process)_  
3.5 Ethical Considerations _(consent, anonymity, insider research)_  
3.6 Project Timeline _(simple table covering prep, data collection, analysis, writing)_
...
4.3 Broader Relevance _(link to higher education debates on skills, employability, digital literacy)_
...
### Appendices _(if needed)_

- Draft survey/interview guide
